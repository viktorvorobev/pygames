[![CI checks](https://github.com/viktorvorobev/pygames/actions/workflows/ci-checks.yaml/badge.svg)](https://github.com/viktorvorobev/pygames/actions/workflows/ci-checks.yaml)
